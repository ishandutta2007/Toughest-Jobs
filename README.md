...
* The total number of applicants for each to calculate the acceptance rates
* A salary comparison across these entry-level positions
* The specific selection numbers for just one of these categories (e.g., individual breakdown of IAS vs. IPS, or Google vs. Amazon)
